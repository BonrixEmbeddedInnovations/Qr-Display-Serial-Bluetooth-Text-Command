...
public class BMPFile {
    ...
    public void saveBitmap(FileOutputStream fos, byte[] imagePix, int parWidth,
                           int parHeight) {
        Log.e("TAG", "saveBitmap hex  " + Apputils.byteArrayToHexString(imagePix));
        try {
    ...
    public byte[] saveBitmap1(FileOutputStream fos, byte[] imagePix, int parWidth,
                              int parHeight) {
        Log.e("TAG", "saveBitmap hex  " + Apputils.byteArrayToHexString(imagePix));
        try {
            return imagePix;
