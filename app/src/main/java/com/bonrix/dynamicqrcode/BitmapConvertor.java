...
public class BitmapConvertor {
     ...
     */
    public static String convertBitmap(Bitmap inputBitmap,AsyncResponse asyncResponse) {
        Log.e("TAG", "convertBitmap " + inputBitmap.getByteCount());
        ...
        ConvertInBackground convert = new ConvertInBackground(asyncResponse);
    ...
    public static byte[] createRawMonochromeData() {
        int length = 0;
    ...
    public static String saveImage(String fileName, int width, int height) {
        FileOutputStream fileOutputStream;
        BMPFile bmpFile = new BMPFile();
        File file = new File(Environment.getExternalStorageDirectory(), "qr" + ".bmp");
        Log.e(TAG, "file. " + file);
...
//        byteArray = bmpFile.saveBitmap1(fileOutputStream, mRawBitmapData, width, height);

        return "Success";
    }

    public static class ConvertInBackground extends AsyncTask<Bitmap, String, Void> {
        public AsyncResponse delegate = null;

        public ConvertInBackground(AsyncResponse delegate) {
        ...
        protected void onPostExecute(Void result) {
            // TODO Auto-generated method stub
            mPd.dismiss();
            delegate.processFinish(mStatus);
